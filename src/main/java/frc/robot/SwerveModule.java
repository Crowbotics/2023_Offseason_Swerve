...
public class SwerveModule {
  ...
  private final PIDController m_drivePIDController = new PIDController(1.25, 0, 0);
  ...
  public SwerveModule(
    ...
    //7.13
    double testNum = 10;
    m_driveEncoder.setPositionConversionFactor(2 * Math.PI * kWheelRadius / 7.13);
    m_driveEncoder.setVelocityConversionFactor(2 * Math.PI * kWheelRadius / 7.13 / 60);
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    final double turnOutput =
        ...
        SmartDashboard.putNumber("Turn Value: ", turnOutput);
